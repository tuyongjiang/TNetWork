...
- (NSNumber *)sendNetWorkingRequest:(TBaseRequest *)baseRequest
    ...
    NSMutableURLRequest *request = [self.sessionManager.requestSerializer requestWithMethod:[baseRequest requestMethodString] URLString:[baseRequest requestUrl] parameters:[baseRequest requestParameter] error:&serializationError];
